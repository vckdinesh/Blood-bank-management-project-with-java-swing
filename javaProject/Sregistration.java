...
public class Sregistration  {
    ...
    public Sregistration() {
        ...
        JLabel lblNewUserRegister = new JLabel("Seeker Registration");
            ...
            public void actionPerformed(ActionEvent e) {
               ...
               String password = String.valueOf(passwordField.getPassword());
                ...
                try {
                    ...
                    String query = "INSERT INTO blood_seeker(name, DOB, BLOODGRP, GENDER, PHONE_NO) values('" + n + "','" + d + "','" + Bgrp + "','" + G + "','" + mobileNumber + "'+'" + mobileNumber + "');";
                    ...
                    String q2 = "INSERT INTO sdetails(password) values ('"+ password +"');";
