...
public class Bloodbanklogin implements ActionListener {
  ...
  public Bloodbanklogin() {
    f2 = new JFrame("Blood Banklogin");
    usernameField = new JTextField(20);
    passwordField = new JPasswordField(20);
    loginButton = new JButton("Login");

    JLabel j1=new JLabel("Blood bank LoginID:");
    f2.add(j1);
  ...
  public void actionPerformed(ActionEvent e){
    ...
    if(e.getActionCommand()=="check"){
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("select id,password from bbdetails ;");
            while(rs.next()){
               u1=rs.getString("id");
