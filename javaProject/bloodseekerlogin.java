...
public class bloodseekerlogin implements ActionListener {
  ...
  public int c=0;
  JFrame f2;
  public  bloodseekerlogin() {
    f2 = new JFrame("Blood seeker login");
    usernameField = new JTextField(20);
    passwordField = new JPasswordField(20);
    loginButton = new JButton("Login");

    JLabel j1=new JLabel("Seeker LoginID:");
    f2.add(j1);
