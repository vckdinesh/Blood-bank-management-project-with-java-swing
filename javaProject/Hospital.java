...
public class Hospital  implements ActionListener{
  ...
  loginButton.setBounds(499,115, 100, 30);
   ...
   j1.setBounds(100,100,200,100);
    ...
    JLabel lblSeekerid = new JLabel("Hospital id :");
    ...
    lblRequestdate.setBounds(350, 195, 124, 36);
    ...
    Request_date.setBounds(437, 194, 160, 40);
    p3.add(Request_date);
   ...
   public void actionPerformed(ActionEvent e){
    ...
    if(e.getActionCommand()=="update"){
        ...
        try {
            ...
            String query ="UPDATE hdetails SET password  ='"+p+"'  WHERE id = '"+id+"';";
...
//    bloodseekerlogin.main(null);
    f.dispose(); 
     ...
     if(e.getActionCommand()=="delete"&& id!=null){
          try {
              Class.forName("com.mysql.cj.jdbc.Driver");
              Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/sys", "root", "#Kh@iDino1$0");
              String query ="delete from hospital where hospital_id='"+c+"';";
              String q2 ="delete from hdetails where id='"+c+"';";
            Statement sta = con.createStatement();
    ...
    if(e.getActionCommand()=="Request"){
            ...
            try {
                ...
                String q1 = "INSERT INTO hrequest(hospital_ID, Blood_bank_id, Bloodgrp, Quantity, Location, Request_date, Status)  values('" + sid + "','" + d + "','" + Bgrp + "','" + G + "','" + ln + "','" + rd + "','not approved');";
...
if(e.getActionCommand()=="payment"){
    ...
    try {
        Class.forName("com.mysql.cj.jdbc.Driver");
                Connection cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/sys", "root", "#Kh@iDino1$0");
                Statement st = cn.createStatement();
        String q1 = "INSERT INTO hpayment (hRequest_id, Quantity, date)  values('"+sd+"','"+quaty+"','2023-01-12');";
        st.executeUpdate(q1);
        String q2 = "UPDATE hrequest SET status = 'approved'  WHERE hrequest_ID = '"+sd+"';";
        st.executeUpdate(q2);
